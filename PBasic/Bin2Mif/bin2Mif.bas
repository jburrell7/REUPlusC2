...
SUB printUsage()
    ...
    STDOUT "     a $ or 0x."
    STDOUT ""
    STDOUT "     The size of output file will be rounded up"
    STDOUT "      to the next 256 byte page value but will not"
    STDOUT "      exceed the size given in the -r paramter"
    STDOUT ""
    ...
    STDOUT ""
    STDOUT "Any binary code exceeding the size given in"
    STDOUT " the -r parameter will be truncated"
